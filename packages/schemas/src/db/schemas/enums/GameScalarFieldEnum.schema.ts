...
export const GameScalarFieldEnumSchema = z.enum(['id', 'createdAt', 'updatedAt', 'startedAt', 'finishedAt', 'pausedAt', 'code', 'status', 'hostId', 'packId', 'currentRoundOrder', 'currentTopicOrder', 'currentQuestionOrder', 'isQuestionRevealed', 'totalActivePlayers', 'totalTopics', 'totalQuestions', 'totalUnresolvedQuestions', 'totalHostSkippedQuestions', 'totalAnswers', 'totalCorrectAnswers', 'totalIncorrectAnswers', 'totalExpiredAnswers', 'totalPointsAwarded', 'totalPointsDeducted', 'durationSeconds', 'winnerId', 'completionDeltas', 'includedTopicPackOrders'])
