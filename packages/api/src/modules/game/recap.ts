...
export async function getCompletedGameRecap(
	...
	const game = await prisma.game.findUnique({
		...
		select: {
			...
			totalTopics: true,
			totalQuestions: true,
			totalUnresolvedQuestions: true,
			totalHostSkippedQuestions: true,
			totalAnswers: true,
	...
	return {
		...
		totals: {
			...
			totalUnresolvedQuestions: game.totalUnresolvedQuestions,
			totalHostSkippedQuestions: game.totalHostSkippedQuestions,
