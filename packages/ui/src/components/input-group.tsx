...
import { Input, type InputProps } from "@xamsa/ui/components/input";
import { Textarea, type TextareaProps } from "@xamsa/ui/components/textarea";
...
export function InputGroup({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: we need to use div for the input group
		<div
			className={cn(
...
export function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: we need to use div for the addon
		<div
