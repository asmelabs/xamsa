...
} from "@xamsa/ui/components/autocomplete";
...
export function CommandPanel({
	...
	return (
		<div
			className={cn(
				"relative -mx-px not-has-[+[data-slot=command-footer]]:-mb-px min-h-0 border border-b-0 bg-popover bg-clip-padding shadow-xs/5 [clip-path:inset(0_1px)] not-has-[+[data-slot=command-footer]]:[clip-path:inset(0_1px_1px_1px_round_0_0_calc(var(--radius-2xl)-1px)_calc(var(--radius-2xl)-1px))] before:pointer-events-none before:absolute before:inset-0 **:data-[slot=scroll-area-scrollbar]:mt-2",
				className,
			)}
			{...props}
		/>
